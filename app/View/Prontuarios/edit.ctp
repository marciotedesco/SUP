...
<?php echo $this->Form->create('Prontuario'); ?>
	<fieldset>
		<legend><?php echo __('Edit Prontuario'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Prontuario.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Prontuario.id'))); ?></li>
